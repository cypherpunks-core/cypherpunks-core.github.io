...
| 子協議 | 功能 | 必需 |
|--------|------|------|
| **Mining Protocol** | 核心挖礦通訊 | 是 |
| **Job Declaration** | 工作聲明（礦工選交易） | 否 |
| **Template Distribution** | 模板分發 | 否 |
...
- [Stratum V2 官方網站](https://stratumprotocol.org/)
- [Stratum Reference Implementation](https://github.com/stratum-mining/stratum)
- [Braiins Stratum V2 文檔](https://braiins.com/stratum-v2)
